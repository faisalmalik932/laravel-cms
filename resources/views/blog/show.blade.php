...
@section('header')
    <!-- Header -->
    <header class="header text-white h-fullscreen pb-80" style="background-image: url({{asset('public/storage/' .$post->image)}});" data-overlay="9">
...
s.src = 'https://saas-blog-zvnksusgxo.disqus.com/embed.js';
